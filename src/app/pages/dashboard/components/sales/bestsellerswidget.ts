        ...
        <ul class="list-none p-0 m-0">
            <li class="flex items-center justify-between pb-2">
                <div class="flex items-center justify-between">
                    <img src="/demo/images/product/bamboo-watch.png" alt="ventana-layout" width="42" height="42" class="rounded-border" />
            ...
            <li class="flex items-center justify-between py-2">
                <div class="flex items-center justify-between">
                    <img src="/demo/images/product/black-watch.png" alt="ventana-layout" width="42" height="42" class="rounded-border" />
                    <div class="ml-2 flex flex-col">
            ...
            <li class="flex items-center justify-between py-2">
                <div class="flex items-center justify-between">
                    <img src="/demo/images/product/blue-band.png" alt="ventana-layout" width="42" height="42" class="rounded-border" />
                    <div class="ml-2 flex flex-col">
            ...
            <li class="flex items-center justify-between py-2">
                <div class="flex items-center justify-between">
                    <img src="/demo/images/product/blue-t-shirt.png" alt="ventana-layout" width="42" height="42" class="rounded-border" />
                    <div class="ml-2 flex flex-col">
            ...
            <li class="flex items-center justify-between py-2">
                <div class="flex items-center justify-between">
                    <img src="/demo/images/product/sneakers.jpg" alt="ventana-layout" width="42" height="42" class="rounded-border" />
                    <div class="ml-2 flex flex-col">
